# unt.aimable CLI Usage

This document covers terminal-only usage of unt.aimable. **For most users, we recommend using the [Desktop UI](#) instead** - it provides a better experience with visual task management, progress tracking, and automatic Python environment setup.

## When to Use CLI

- You prefer terminal workflows
- You're running on a headless server
- You're integrating unt.aimable into scripts or CI/CD
...
unt.aimable uses Git worktrees for isolated builds:
