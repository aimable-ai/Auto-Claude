...
unt.aimable uses a three-layer security model:
...
unt.aimable is free to use. If you modify and distribute it, or run it as a service, your code must also be open source under AGPL-3.0.
