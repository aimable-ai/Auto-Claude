      ...
      const postResult = await withProjectOrNull(projectId, async (project) => {
        ...
        try {
          ...
          if (options?.forceApprove) {
            ...
            body = `## ✅ unt.aimable Review - APPROVED\n\n`;
            ...
            body += `*Generated by unt.aimable*`;
          } else {
            // Standard review format
            body = `## 🤖 unt.aimable PR Review\n\n${result.summary}\n\n`;
            ...
            body += `---\n*This review was generated by unt.aimable.*`;
          }
