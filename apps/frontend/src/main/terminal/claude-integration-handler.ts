...
export function handleOAuthToken(
  ...
  if (OutputParser.hasLoginSuccess(data) && profileId) {
    ...
    if (keychainCreds.token) {
      ...
      // Storing causes unt.aimable to use a stale cached token instead of letting
 ...
 * since unt.aimable already restores terminals to their correct cwd/projectPath.
 *
...
export function resumeClaude(
  ...
  try {
    ...
    // This is more reliable than --resume with session IDs since unt.aimable already restores
