...
describe('PRDetail Clean Review Functionality', () => {
  ...
  describe('Clean Review Comment Format', () => {
    it('should format clean review comment correctly', () => {
      ...
      const cleanReviewMessage = `## ✅ unt.aimable PR Review - PASSED
...
*This automated review found no issues. Generated by unt.aimable.*`;

      expect(cleanReviewMessage).toContain('## ✅ unt.aimable PR Review - PASSED');
      expect(cleanReviewMessage).toContain('**Status:** All code is good');
      expect(cleanReviewMessage).toContain(reviewResult.summary);
      expect(cleanReviewMessage).toContain('*This automated review found no issues. Generated by unt.aimable.*');
    });
