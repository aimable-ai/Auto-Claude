...
export function App() {
  ...
  // GitHub setup state (shown after unt.aimable init)
  ...
  const handleInitialize = async () => {
    ...
    try {
      ...
      if (result?.success) {
        ...
        const errorMessage = result?.error || 'Failed to initialize unt.aimable. Please try again.';
  ...
  return (
    <ViewStateProvider>
      ...
      <div className="flex h-screen bg-background">
        ...
        {/* GitHub Setup Modal - shows after unt.aimable init to configure GitHub */}
        {gitHubSetupProject && (
          <GitHubSetupModal
